...
/**
 * Binding allowing to transform a {@link io.ibj.JLib.logging.event.interfaces.MessageInterface} into a JSON stream.
 */
public class MessageInterfaceBinding implements io.ibj.JLib.logging.marshaller.json.InterfaceBinding<MessageInterface> {
    /**

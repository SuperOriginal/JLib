...
/**
 * Binding allowing to convert a {@link io.ibj.JLib.logging.event.interfaces.StackTraceInterface} into a JSON stream.
 */
public class StackTraceInterfaceBinding implements io.ibj.JLib.logging.marshaller.json.InterfaceBinding<StackTraceInterface> {

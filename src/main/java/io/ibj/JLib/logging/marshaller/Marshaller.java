package io.ibj.JLib.logging.marshaller;
...
/**
 * Marshaller allows to serialise a {@link io.ibj.JLib.logging.event.Event} and sends over a stream.
 */
public interface Marshaller {
    /**
     * Serialises an event and sends it through an {@code OutputStream}.
     * <p>
     * The marshaller should not close the given stream, use {@link io.ibj.JLib.logging.marshaller.Marshaller.UncloseableOutputStream} to prevent automatic calls

 ...
 * <p>
 * The content can also be compressed with {@link java.util.zip.DeflaterOutputStream} in which case the binary result is encoded
 * in base 64.
 * </p>
 */
...
/*        if (compression)
            destination = new DeflaterOutputStream(BaseEncoding.base64().encodingStream(
    ...
    /**
     * Add an interface binding to send a type of {@link io.ibj.JLib.logging.event.interfaces.SentryInterface} through a JSON stream.
     *
     * @param sentryInterfaceClass Actual type of SentryInterface supported by the {@link io.ibj.JLib.logging.marshaller.json.InterfaceBinding}

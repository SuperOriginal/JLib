...
public class SentryHandler extends Handler {
    /**
     * Name of the {@link io.ibj.JLib.logging.event.Event#extra} property containing the Thread id.
     */
    public static final String THREAD_ID = "Raven-Threadid";
    /**
     * Current instance of {@link io.ibj.JLib.logging.Raven}.
     *
     * @see #initRaven()
     */
    ...
    /**
     * Name of the {@link io.ibj.JLib.logging.RavenFactory} being used.
     * <p>
    ...
    /**
     * Transforms a {@link java.util.logging.Level} into an {@link io.ibj.JLib.logging.event.Event.Level}.
     *

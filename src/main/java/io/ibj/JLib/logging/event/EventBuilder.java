package io.ibj.JLib.logging.event;
...
/**
 * Builder to assist the creation of {@link io.ibj.JLib.logging.event.Event}s.
 */
public class EventBuilder {
     ...
     *
     * @see io.ibj.JLib.logging.event.EventBuilder.HostnameCache
     */
    ...
    /**
     * Creates a new EventBuilder to prepare a new {@link io.ibj.JLib.logging.event.Event}.
     * <p>
    ...
    /**
     * Adds a {@link io.ibj.JLib.logging.event.interfaces.SentryInterface} to the event.
     * <p>
     ...
     * for the creation of each {@link io.ibj.JLib.logging.event.Event}. This system will prevent unnecessary costs by keeping track of the

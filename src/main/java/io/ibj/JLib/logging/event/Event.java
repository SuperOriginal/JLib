 ...
 * <p>
 * For security purposes, an event should be created from an {@link io.ibj.JLib.logging.event.EventBuilder} only, and be completely immutable
...
public class Event implements Serializable {
     ...
     * <p>
     * Automatically created with a Map that is made unmodifiable by the {@link io.ibj.JLib.logging.event.EventBuilder}.
     * </p>
     */
    ...
    /**
     * Creates a new Event (should be called only through {@link io.ibj.JLib.logging.event.EventBuilder} with the specified identifier.
     *

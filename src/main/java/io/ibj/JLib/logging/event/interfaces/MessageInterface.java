 ...
 * {@link io.ibj.JLib.logging.event.Event} with the message "<cite>User1 failed to provide an email address</cite>"
 ...
 * </p>
 */
public class MessageInterface implements io.ibj.JLib.logging.event.interfaces.SentryInterface {
    /**
     ...
     * recommended to use {@link io.ibj.JLib.logging.event.EventBuilder#setMessage(String)} instead.
     * </p>
     *
     * @param message message to add to the event.
     * @deprecated Use {@link io.ibj.JLib.logging.event.EventBuilder#setMessage(String)} instead.
     */
    @Deprecated
    ...
    /**
     * Creates a parametrised message for an {@link io.ibj.JLib.logging.event.Event}.
     *

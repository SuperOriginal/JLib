...
/**
 * Factory in charge of creating {@link io.ibj.JLib.logging.Raven} instances.
 * <p>
 * The factories register themselves through the {@link java.util.ServiceLoader} system.
 * </p>
 */
public abstract class RavenFactory {
     ...
     * <p>
     * Usually RavenFactories are automatically detected with the {@link java.util.ServiceLoader} system, but some systems
    ...
    /**
     * Creates an instance of Raven using the DSN obtain through {@link io.ibj.JLib.logging.dsn.Dsn#dsnLookup()}.
     *
     * @return an instance of Raven.
     */
    public static io.ibj.JLib.logging.Raven ravenInstance() {
     ...
     * @return an instance of Raven.
     */
    public static io.ibj.JLib.logging.Raven ravenInstance(String dsn) {
     ...
     * @return an instance of Raven.
     */
    public static io.ibj.JLib.logging.Raven ravenInstance(Dsn dsn) {
     ...
     */
    public static io.ibj.JLib.logging.Raven ravenInstance(Dsn dsn, String ravenFactoryName) {
        ...
        for (RavenFactory ravenFactory : getRegisteredFactories()) {
            ...
            try {
                io.ibj.JLib.logging.Raven ravenInstance = ravenFactory.createRavenInstance(dsn);
     ...
     */
    public abstract io.ibj.JLib.logging.Raven createRavenInstance(Dsn dsn);
}

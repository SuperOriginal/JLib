...
import io.ibj.JLib.logging.connection.AsyncConnection;
import io.ibj.JLib.logging.connection.Connection;
import io.ibj.JLib.logging.connection.HttpConnection;
import io.ibj.JLib.logging.connection.UdpConnection;
import io.ibj.JLib.logging.dsn.Dsn;
import io.ibj.JLib.logging.event.interfaces.ExceptionInterface;
import io.ibj.JLib.logging.event.interfaces.MessageInterface;
import io.ibj.JLib.logging.event.interfaces.StackTraceInterface;
import io.ibj.JLib.logging.marshaller.Marshaller;
import io.ibj.JLib.logging.marshaller.json.*;
...
/**
 * Default implementation of {@link io.ibj.JLib.logging.RavenFactory}.
 * <p>
...
public class DefaultRavenFactory extends RavenFactory {
    ...
    /**
     * Encapsulates an already existing connection in an {@link io.ibj.JLib.logging.connection.AsyncConnection} and get the async options from the
     * Sentry DSN.
     *
     * @param dsn        Data Source Name of the Sentry server.
     * @param connection Connection to encapsulate in an {@link io.ibj.JLib.logging.connection.AsyncConnection}.
     ...
     *
     * @param dsn Data Source Name of the Sentry server.
     * @return an {@link io.ibj.JLib.logging.connection.HttpConnection} to the server.
     */
     ...
     *
     * @param dsn Data Source Name of the Sentry server.
     * @return an {@link io.ibj.JLib.logging.connection.UdpConnection} to the server.
     */
    ...
    /**
     * Creates a JSON marshaller that will convert every {@link io.ibj.JLib.logging.event.Event} in a format
     * handled by the Sentry server.
     *
     * @param dsn Data Source Name of the Sentry server.
     * @return a {@link io.ibj.JLib.logging.marshaller.json.JsonMarshaller} to process the events.
     */
     ...
     * <p>
     * Those packages will be used with the {@link io.ibj.JLib.logging.event.interfaces.StackTraceInterface} to hide frames that aren't a part of

...
/**
 * JNDI Lookup allows to do a JNDI lookup without tying {@link io.ibj.JLib.logging.dsn.Dsn} to the JNDI libraries.
 * <p>
 * Android does not support JNDI making the automatic lookup through JNDI illegal and fatal to the application.
 * Having the lookup in a separate class allows the classloader to load {@link io.ibj.JLib.logging.dsn.Dsn} without exceptions.
 * </p>
 */
